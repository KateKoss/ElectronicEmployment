...
namespace MyCourseWork {
    ...
    public partial class EmployeesDataSet1 : global::System.Data.DataSet {
        ...
        public partial class VacancyDataTable : global::System.Data.TypedTableBase<VacancyRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public VacancyRow AddVacancyRow(string Sector, string Place, string Company, string Requirements, decimal Salary, string Location) {
        ...
        public partial class VacancyRow : global::System.Data.DataRow {
            ...
            public string Place {
                get {
                    try {
                        return ((string)(this[this.tableVacancy.PlaceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Place\' в таблице \'Vacancy\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableVacancy.PlaceColumn] = value;
                }
            }
            ...
            public bool IsPlaceNull() {
                return this.IsNull(this.tableVacancy.PlaceColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPlaceNull() {
                this[this.tableVacancy.PlaceColumn] = global::System.Convert.DBNull;
            }
...
namespace MyCourseWork.EmployeesDataSet1TableAdapters {
    ...
    public partial class VacancyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Vacancy` WHERE ((`ID` = ?) AND ((? = 1 AND `Sector` IS NULL) OR (`Sector` = ?)) AND ((? = 1 AND `Place` IS NULL) OR (`Place` = ?)) AND ((? = 1 AND `Company` IS NULL) OR (`Company` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)) AND ((? = 1 AND `Location` IS NULL) OR (`Location` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Vacancy` (`Sector`, `Place`, `Company`, `Requirements`, `Salary`, `L" +
                "ocation`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Vacancy` SET `Sector` = ?, `Place` = ?, `Company` = ?, `Requirements` = ?, `Salary` = ?, `Location` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Sector` IS NULL) OR (`Sector` = ?)) AND ((? = 1 AND `Place` IS NULL) OR (`Place` = ?)) AND ((? = 1 AND `Company` IS NULL) OR (`Company` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)) AND ((? = 1 AND `Location` IS NULL) OR (`Location` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Sector, Place, Company, Requirements, Salary, Location FROM Vacancy";
        ...
        public virtual int Fill(EmployeesDataSet1.VacancyDataTable dataTable) {
        ...
        public virtual EmployeesDataSet1.VacancyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmployeesDataSet1.VacancyDataTable dataTable = new EmployeesDataSet1.VacancyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmployeesDataSet1.VacancyDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Sector, string Original_Place, string Original_Company, global::System.Nullable<decimal> Original_Salary, string Original_Location) {
        ...
        public virtual int Insert(string Sector, string Place, string Company, string Requirements, global::System.Nullable<decimal> Salary, string Location) {
            if ((Sector == null)) {
        ...
        public virtual int Update(string Sector, string Place, string Company, string Requirements, global::System.Nullable<decimal> Salary, string Location, int Original_ID, string Original_Sector, string Original_Place, string Original_Company, global::System.Nullable<decimal> Original_Salary, string Original_Location) {
            if ((Sector == null)) {
